<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
        ...
        $sql = "UPDATE QUESTION SET question_text = '$question', option_a = '$option_a', option_b = '$option_b', option_c = '$option_c', correct_option = '$correct_option' WHERE question_id = $question_id";
        $conn->query($sql);
